    ...
    <section id="home_two_banner">
        <div class="home_two_banner_slider_wrapper owl-carousel owl-theme">
            ...
            <div class="banner_two_slider_item fadeInUp" data-wow-duration="2s"
                style="background-image: url(./assets/img/banner/banner-two-bg-3.png);">
                <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="top_service_boxed">
                        <img src="assets/img/icon/s3.png" width="120px" alt="icon">
                        <h3>จัดอบรมสัมมนา</h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="top_service_boxed">
                        <img src="assets/img/icon/s2.png" width="120px"  alt="icon">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="top_service_boxed">
                        <img src="assets/img/icon/s4.png" width="120px"  alt="icon">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="top_service_boxed">
                        <img src="assets/img/icon/s5.png" width="120px" alt="icon">
                        <h3>แปลเอกสาร</h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="top_service_boxed">
                        <img src="assets/img/icon/s6.png" width="120px"  alt="icon">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="top_service_boxed">
                        <img src="assets/img/icon/s7.png" width="120px"  alt="icon">
            ...
            <div class="row align-items-center">
                ...
                <div class="co-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="copyright_right">
                        <img src="assets/img/common/cards.png" width="100px" alt="img">
                    </div>
                </div>
            </div>
        </div>
