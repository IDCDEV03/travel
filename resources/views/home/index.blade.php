...
<head>
    ...
    {{asset('assets_home/css/bootstrap.min.css')}}"/>
    <!-- animate css -->
        ...
        <div class="home_two_banner_slider_wrapper owl-carousel owl-theme">
            ...
            <div class="banner_two_slider_item fadeInUp" data-wow-duration="2s"
                style="background-image: url(
                    {{asset('assets_home/img/banner/banner-two-bg-3.png')}}
                    ">
                <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="top_service_boxed">
                        <img src="{{asset('assets_home/img/icon/s3.png')}}" width="120px" alt="icon">
                        <h3>จัดอบรมสัมมนา</h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="top_service_boxed">
                        <img src="{{asset('assets_home/img/icon/s2.png')}}" width="120px"  alt="icon">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="top_service_boxed">
                        <img src="{{asset('assets_home/img/icon/s4.png')}}" width="120px"  alt="icon">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="top_service_boxed">
                        <img src="{{asset('assets_home/img/icon/s5.png')}}" width="120px" alt="icon">
                        <h3>แปลเอกสาร</h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="top_service_boxed">
                        <img src="{{asset('assets_home/img/icon/s6.png')}}" width="120px"  alt="icon">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="top_service_boxed">
                        <img src="{{asset('assets_home/img/icon/s7.png')}}" width="120px"  alt="icon">
            ...
            <div class="row">
                        ...
                        <div class="about_two_left_middel">
                            <div class="about_two_item">
                                <div class="about_two_item_icon">
                                    <img src="{{asset('assets_home/img/icon/about-1.png')}}" alt="icon">
                                </div>
                            ...
                            <div class="about_two_item">
                                <div class="about_two_item_icon">
                                    <img src="{{asset('assets_home/img/icon/about-2.png')}}" alt="icon">
                                </div>
                                <div class="about_two_item_text">
                                    <h3>Visa Service</h3>
                            ...
                            <div class="about_two_item">
                                <div class="about_two_item_icon">
                                    <img src="{{asset('assets_home/img/icon/about-3.png')}}" alt="icon">
                                </div>
                                <div class="about_two_item_text">
                                    <h3>Car Rent</h3>
                ...
                <div class="col-lg-7 col-md-12 col-sm-12 col-12">
                    <div class="about_two_left_img">
                        <img src="{{asset('assets_home/img/common/about_two.jpg')}}" alt="img">
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="holiday_small_boxed">
                                <a href="top-destinations-details.html">
                                    <img src="{{asset('assets_home/img/holiday-img/holiday-1.png')}}" alt="img">
                                 
                                </a>
                            </div>
                            <div class="holiday_small_boxed">
                                <a href="top-destinations-details.html">
                                    <img src="{{asset('assets_home/img/holiday-img/holiday-2.png')}}" alt="img">
                        ...
                        <div class="col-lg-6">
                            <div class="holiday_small_boxed">
                                <a href="top-destinations-details.html">
                                    <img src="{{asset('assets_home/img/holiday-img/holiday-3.jpg')}}" alt="img">                             
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                    <div class="holiday_small_boxed">
                                        <a href="top-destinations-details.html">
                                            <img src="{{asset('assets_home/img/holiday-img/holiday-5.jpg')}}" alt="img">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                    <div class="holiday_small_boxed">
                                        <a href="top-destinations-details.html">
                                            <img src="{{asset('assets_home/img/holiday-img/holiday-6.jpg')}}" alt="img">
