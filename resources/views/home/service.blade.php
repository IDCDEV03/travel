            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="about_us_right">
                        <img src="{{asset('assets_home/img/common/abour_right.jpg')}}" alt="img">
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="about_service_boxed">
                        <img src="{{asset('assets_home/img/icon/vietnam.png')}}" width="50px" alt="img">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="about_service_boxed">
                        <img src="{{asset('assets_home/img/icon/thailand.png')}}" width="50px" alt="img">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="about_service_boxed">
                        <img src="{{asset('assets_home/img/icon/laos.png')}}" width="50px" alt="img">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="about_offer_banner">
                      <img src="{{asset('assets_home/img/common/small_banner.jpg')}}" alt="img">
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="about_offer_banner">
                        <img src="{{asset('assets_home/img/common/big_banner.jpg')}}" alt="img">
