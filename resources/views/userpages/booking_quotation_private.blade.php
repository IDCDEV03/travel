...
<div class="col-md-4">
    <div class="media">
        <div class="media-body m-l-20">
            ...
            <p>
                {{$item->member_email}} 
                <br><span>โทร.{{$item->user_phone}} </span></p>
        </div>
    </div>
</div>
</div>
                   ...
                   <span class="txt-success">หมายเหตุ : ชำระมัดจำงวดที่ 1 แล้ว </span>
                    @endif
                                ...
                                <div id="non-printable">
                                    ...
                                    <a href="{{url('/user/payment/'.$item->quotation_id.'/private')}}" class="btn btn-secondary">แจ้งชำระเงิน</a>
                                    @endif
