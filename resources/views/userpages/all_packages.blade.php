    ...
    <div class="container-fluid">
        <div class="product-wrapper-grid">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4 text-center">
                                <a href="{{ route('private_package', ['id' => Auth::user()->id]) }}"
            ...
            <div class="col-md-6 text-center">
                <input class="form-control" placeholder="ค้นหาทัวร์ (ชื่อเมือง หรือ ประเทศ)" name="search" type="search" value="{{$search}}">
            </div>
            <div class="col-md-6 text-center">
                <button type="submit" class="btn btn-primary">Search</button>
                <a href="{{route('user.all_packages')}}" class="btn btn-info"
                type="button">Reset</a>
            </div>
                                    </div>
                                </form>
                                        ...
                                        <ul>
                                            <li>
                                                <button class="btn" type="button" data-bs-toggle="modal"
                                                    data-bs-target="#Modal_{{ $row->package_id }}"><i
                                                ...
                                                <div class="product-box row">
                                                    ...
                                                    <div class="product-details col-lg-6 text-start">
                                                        ...
                                                        <div class="product-price">
                                                            {{ number_format($row->package_price) }}.-
                                                        </div>
                                                        ...
                                                        <div class="product-qnty">
                                                            <div class="addcart-btn">
                                                                <a href="{{ route('book_package', ['id' => Auth::user()->id, 'pkid' => $row->package_id]) }}"
