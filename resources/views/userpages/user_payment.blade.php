...
@section('content')
    <div class="container-fluid">
        ...
        <div class="col-sm-12">
            ...
            <div class="card-body">
        <div class="row">
            <div class="col-md-4"><span>ธนาคารกรุงไทย</span></div>
            <div class="col-md-4"><span>ชื่อบัญชี : </span></div>
            <div class="col-md-4"><span>420-000-000</span></div>
        </div>
    </div>
    </div>
                    ...
                    <div class="col">
                        <div class="m-t-15 m-checkbox-inline custom-radio-ml">
                          <div class="form-check form-check-inline radio radio-primary">
                            ...
                            <label class="form-check-label mb-0 " for="radioinline1">ธนาคารกรุงไทย</label>
                          </div>
                          <div class="form-check form-check-inline radio radio-primary">
                            <input class="form-check-input" id="radioinline2" type="radio" name="payment_bank" value="ธนาคารกสิกรไทย">
                            <label class="form-check-label mb-0" for="radioinline2">ธนาคารกสิกรไทย</label>
                          </div>  
                          @error('payment_bank')
                          <span class="text-danger my-2">
                              << {{ $message }} >> </span>
