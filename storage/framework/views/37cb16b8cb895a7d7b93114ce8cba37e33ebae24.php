                            ...
                            <div class="row">
                                <div class="col">
                                  <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="account_nummber" value="<?php echo e($row->account_nummber); ?>">
                                  </div>
                                </div>
                            </div>
                            <div class="row">
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\travel\resources\views/admin/bank_edit.blade.php ENDPATH**/ ?>