                                        ...
                                        <ul>
                                            <li>
                                                <button class="btn" type="button" data-bs-toggle="modal"
                                                    data-bs-target="#Modal_<?php echo e($row->package_id); ?>"><i
                                                ...
                                                <div class="product-box row">
                                                    ...
                                                    <div class="product-details col-lg-6 text-start">
                                                        ...
                                                        <div class="product-price">
                                                            <?php echo e(number_format($row->package_price)); ?>.-
                                                        </div>
                                                        ...
                                                        <div class="product-qnty">
                                                            <div class="addcart-btn">
                                                                <a href="<?php echo e(route('book_package', ['id' => Auth::user()->id, 'pkid' => $row->package_id])); ?>"
                                                                    class="btn btn-primary"
                                                                    type="button">สั่งจองแพ็คเกจนี้</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
<?php echo $__env->make('userLayouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\travel\resources\views/userpages/all_packages.blade.php ENDPATH**/ ?>