...
<head>
    ...
    <!-- Title -->
    <title>บริการของเรา - S&P Inter Tour </title>
    <!-- Bootstrap css -->
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="about_us_left">
                        <h5>S&P Inter Tour</h5>
                        <h2>บริการของเรา
                        </h2>
                        <p>จัดอบรม-สัมมนา ศึกษาดูงาน จัดนำเที่ยว , ปรึกษาวีซ่า, ตั๋วเครื่องบิน, แปลเอกสาร , ท่องเที่ยวแบบ Home stay  , Long stay </p>
 
                        <a href="#" class="btn btn_theme btn_md">ขอใบเสนอราคา</a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="about_us_right">
                        <img src="<?php echo e(asset('assets_home/img/common/abour_right.jpg')); ?>" alt="img">
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="about_service_boxed">
                        <img src="<?php echo e(asset('assets_home/img/icon/vietnam.png')); ?>" width="50px" alt="img">
                        <h5><a href="#!">โปรแกรมท่องเที่ยวเวียดนาม</a></h5>
                        <p>เวียดนามกลาง 4 วัน 3 คืน ดานัง เว้ ฮอยอัน บานาฮิลล์</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="about_service_boxed">
                        <img src="<?php echo e(asset('assets_home/img/icon/thailand.png')); ?>" width="50px" alt="img">
                        <h5><a href="#!">1 Day Trip in Udonthani</a></h5>
                        <p>วัดโพธิสมภรณ์ พระอารามหลวง อุดรธานี / วัดป่าบ้านตาด (วัดเกษรศีลคุณ) หลวงตามหาบัว / ศูนย์วัฒนธรรมไทย-จีน อุดรธานี</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="about_service_boxed">
                        <img src="<?php echo e(asset('assets_home/img/icon/laos.png')); ?>" width="50px" alt="img">
                        <h5><a href="#!">สะบายดี เวียงจันทร์ 1 Day Trip </a></h5>
                        <p>พิพิธภัณฑ์หอพระแก้ว / หอคำ / วัดสีสะเกด / ประตูชัย / พระธาตุหลวง</p>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="about_offer_banner">
                      <img src="<?php echo e(asset('assets_home/img/common/small_banner.jpg')); ?>" alt="img">
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="about_offer_banner">
                        <img src="<?php echo e(asset('assets_home/img/common/big_banner.jpg')); ?>" alt="img">
...
</html><?php /**PATH C:\xampp\htdocs\travel\resources\views/home/service.blade.php ENDPATH**/ ?>