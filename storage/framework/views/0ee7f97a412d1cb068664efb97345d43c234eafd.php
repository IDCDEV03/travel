                                    ...
                                    <tr>
                                        ...
                                        <td>
                                               ...
                                               <i class="fa fa-edit"></i></a>
                                                <a href="<?php echo e(route('admin.user_delete', ['id' => $row->id])); ?>" class="btn btn-danger" onclick="return confirm('ต้องการลบ ใช่หรือไม่?');"><i class="fa fa-trash-o"></i></a>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\travel\resources\views/admin/user_data.blade.php ENDPATH**/ ?>