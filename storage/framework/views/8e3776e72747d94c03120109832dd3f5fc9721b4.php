        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="list-group"><a class="list-group-item list-group-item-action flex-column align-items-start "
                    ...
                    </a><a href="<?php echo e(route('booking_status')); ?>" class="list-group-item list-group-item-action flex-column align-items-start"
...
<?php echo $__env->make('userLayouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\travel\resources\views/userPages/home.blade.php ENDPATH**/ ?>