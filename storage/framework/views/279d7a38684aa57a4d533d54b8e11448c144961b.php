                    ...
                    <div class="promotional_tour_slider owl-theme owl-carousel dot_style">
                        ...
                        <div class="theme_common_box_two img_hover">
                            <div class="theme_two_box_img">
                                <a href="<?php echo e(route('detail.show', ['id' => $item->package_id])); ?>"><img src="<?php echo e(asset($item->package_cover)); ?>" alt="img"></a>
                                <p><i class="fas fa-map-marker-alt"></i><?php echo e($item->package_place); ?></p>
                            </div>
                            <div class="theme_two_box_content">
                                <h4><a href="<?php echo e(route('detail.show', ['id' => $item->package_id])); ?>"><?php echo e($item->package_name); ?></a></h4>
                           
                                <h3><?php echo e(number_format($item->package_price)); ?>.- <span>/ คน</span></h3>
                            </div>
                        </div>           
            ...
            <div class="row align-items-center">
                ...
                <div class="co-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="copyright_right">
                        <img src="<?php echo e(asset('assets_home/img/logo-mini.png')); ?>" width="100px" alt="img">
                    </div>
                </div>
            </div>
        </div>
