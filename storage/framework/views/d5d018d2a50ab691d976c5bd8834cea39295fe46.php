...
<head>
    ...
    <!-- Title -->
    <title>เกี่ยวกับเรา - S&P Inter Tour </title>
    <!-- Bootstrap css -->
                ...
                <div class="col-lg-12">
                    <div class="terms_service_content">
                        <div class="terms_item">
                            <h4>ห้างหุ้นส่วนจำกัด เอส แอนด์ พี อินเตอร์เนชั่นแนลเซอร์วิส</h4>
                            <p>ประกอบกิจการธุรกิจนำเที่ยว ใบอนุญาตเลขที่ 51/00895</p>
                            <p>
                                สำนักงานตั้งอยู่ที่ 8/4 ม.1  ถ.หน้าสนามบินนานาชาติอุดรธานี  อ. เมือง  จ.อุดรธานี 41000 
                            </p>
                        </div>
                        <div class="news_item_img">
                       <img src="<?php echo e(asset('assets_home/img/news/news-two-1.png')); ?>" alt="img">
                            </div>
                        <div class="terms_item">
                            <h4>เราให้บริการ</h4>
                            <p>
                                <ul>
                                    <li><i class="fas fa-circle"></i> รับจัดนำเที่ยว อบรม สัมมนา ทั้งใน-ต่างประเทศ</li>
                                    <li><i class="fas fa-circle"></i> พานักเรียน-นักศึกษาไป Summer ต่างประเทศ</li>
                                    <li><i class="fas fa-circle"></i> รถเช่า: รถตู้ VIP รถโค้ชปรับอากาศ </li>
                                    <li><i class="fas fa-circle"></i> รับปรึกษา วีซ่า เพื่ออยู่ในเมืองไทย หรือจะไปต่างประเทศ</li>
                                </ul>
                            </p>
            ...
            <div class="row">      
                <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                    <div class="tour_guides_boxed">
                        <img src="<?php echo e(asset('assets_home/img/sp01.jpg')); ?>" alt="img">
                     
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                    <div class="tour_guides_boxed">
                        <img src="<?php echo e(asset('assets_home/img/sp02.jpg')); ?>" alt="img">
                      
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                    <div class="tour_guides_boxed">
                        <img src="<?php echo e(asset('assets_home/img/sp03.jpg')); ?>" alt="img">
                      
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                    <div class="tour_guides_boxed">
                        <img src="<?php echo e(asset('assets_home/img/sp04.jpg')); ?>" alt="img">
...
</html><?php /**PATH C:\xampp\htdocs\travel\resources\views/home/about-us.blade.php ENDPATH**/ ?>